...
1.App is deployed on an AWS EC2 instance.
2.Data and models are stored on S3 buckets.
3.Streamlit is reverse-proxied using Nginx (optional for production).

##📊 Sample Output
Input song: Blinding Lights Recommended songs:
